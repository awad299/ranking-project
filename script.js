...
const scriptUrl = "https://script.google.com/macros/s/AKfycbx4jaaSCh6FvfuvXqUhucS94cLk_GResu5MWINT2jS9F6lPCIZX7zcOUh1p4CwqbdaK/exec";
...
function showStudentDetails(name, weekData) {
  ...
  days.forEach(day => {
    ...
    let total = 0;
    const row = [day];
    ["المشاركة", "الواجب", "السلوك", "الاختبار"].forEach(type => {
      const key = day + " - " + type;
